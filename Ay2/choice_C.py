...
# --- データ読み込み ---
ch_101 = load_choices("yobi2/ep1_result/choice_history.json")
ch_102 = load_choices("yobi2/ep2_result/choice_history.json")
ch_103 = load_choices("yobi2/ep3_result/choice_history.json")
